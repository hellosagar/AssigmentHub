...
public final class Teacher implements Model {
  ...
  public static final QueryField EMAIL = field("Teacher", "email");
  private final @ModelField(targetType="ID", isRequired = true) String id;
  private final @ModelField(targetType="String", isRequired = true) String name;
  private final @ModelField(targetType="String", isRequired = true) String email;
  private final @ModelField(targetType="Assignment") @HasMany(associatedWith = "teacherID", type = Assignment.class) List<Assignment> assignments = null;
  public String getId() {
      return id;
  }
  ...
  private Teacher(String id, String name, String email) {
    this.id = id;
    this.name = name;
    this.email = email;
  }
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), teacher.getId()) &&
              ObjectsCompat.equals(getName(), teacher.getName()) &&
              ObjectsCompat.equals(getEmail(), teacher.getEmail());
      }
  }
   ...
   */
  public static Teacher justId(String id) {
    try {
